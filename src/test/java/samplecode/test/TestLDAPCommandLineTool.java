...
/**
 * provides support for basic LDAP command line tools; a convenient way to get the basic {@code
 * LDAPCommandLineTool} command line arguments used in testing.
 */
class TestLDAPCommandLineTool extends LDAPCommandLineTool
{
  ...
  /**
   * Adds the arguments needed by this command-line tool to the provided argument parser which are
   * not related to connecting or authenticating to the directory server.
   *
   * @param parser
  ...
  /**
   * Retrieves the name of this tool.  It should be the name of the command used to invoke this
   * tool.
   *
   ...
   *
   * @return A result code that indicates whether the processing completed successfully.
   */
  @Override
