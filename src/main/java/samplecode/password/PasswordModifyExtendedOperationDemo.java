...

{
    ...
    private static final String RESOURCE_NAME = "PasswordModifyExtendedOperationDemo.properties";
     ...
     */
    @Override
    protected void addArguments(final ArgumentParser argumentParser) throws 
            ArgumentException {
    /*
     ...
     */
        ...
        final String longIdentifier = PasswordModifyExtendedOperationDemo
        ...
        final String description =
                "The parameter of this argument is used as the new password. " + "If this" +
                        " command" +
                        " line argument is not present " + "the server must generate a " +
                        "new " +
