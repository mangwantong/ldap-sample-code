...

{
   ...
   * <p/>
   * <pre>
   * Demonstrates the use of the PasswordModifyExtendedRequest by changing
   * the
   * existing password specified by the --bindPassword command line argument
   * to the
   ...
   *     The path to the file to use as trust store when determining whether
   * to
   ...
   *     Specifies the maximum length of time in milliseconds that a
   * connection
   ...
   *     The maximum length of time in milliseconds that an operation should
   * be
   ...
   *     Specifies the maximum number of reports. This command line argument
   * is
   ...
   *     The client-request maximum number of results which are returned to
   * the
   ...
   * size
   *     limit a SIZE_LIMIT_EXCEEDED code is returned in the result code in
   * the
   *     search response.
   ...
   *     The parameter of this argument is used as the new password. If this
   * command
   *     line argument is not present the server must generate a new password
   * and
   ...
   */
  private static final String ARG_NAME_NEW_PASSWORD = "newPassword";


  private static final String RESOURCE_NAME =
    "PasswordModifyExtendedOperationDemo.properties";
  ...
  protected void addArguments(final ArgumentParser argumentParser)
    ...
    final StringArgument stringArgument =
      new StringArgument('n',
        PasswordModifyExtendedOperationDemo.ARG_NAME_NEW_PASSWORD,false,
        1,"{new-password}","The parameter of this argument is used as the new" +
        " password.  If this command line argument is not present the server " +
  ...
  protected ResultCode executeToolTasks() {
    ...
    final String newPassword = (String) commandLineOptions.get(name);
