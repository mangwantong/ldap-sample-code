  ...
  implements ToolCompletedProcessing
{
   ...
   */
  @Override
  public void displayMessage(final PrintStream outStream,
      final PrintStream errStream)
  {
    ...
    final LdapLogRecord ldapLogRecord =
        new BasicLdapLogRecord(String.format(
            ...
            this.tool.getToolName(),this.resultCode));
    if(this.resultCode.equals(ResultCode.SUCCESS))
    {
      outStream.println(new MinimalLogFormatter().format(ldapLogRecord
          .getLogRecord(Level.INFO)));
    }
    else
    {
      errStream.println(new MinimalLogFormatter().format(ldapLogRecord
          .getLogRecord(Level.INFO)));
    }
  }
