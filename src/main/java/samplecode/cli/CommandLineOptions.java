...
public class CommandLineOptions {
     ...
     */
    public static final Argument[] createDefaultArguments(final ResourceBundle
                                                                  resourceBundle)
        ...
        return new Argument[]{abandonOnTimeoutArgument,attributeArgument,
                autoReconnectArgument,
                baseObjectArgument,requiresPasswordArgument,connectTimeoutArgument,
                filterArgument,
                initialConnectionArgument,cwArgument,maxConnectionArgument,
                maxResponseTimeArgument,
                numThreadsArgument,pageSizeArgument,reportCountArgument,
                reportIntervalArgument,
                scopeArgument,sizeLimitArgument,timeLimitArgument,usePropertiesFileArgument,
     ...
     *                           line argument.
     */
    public static CommandLineOptions newCommandLineOptions(final ArgumentParser
                                                                   argumentParser,
    ...
    public SearchScope getSearchScope() {
        ...
        final ScopeArgument arg =
                (ScopeArgument)argumentParser.getNamedArgument(CommandLineOptions
                        .ARG_NAME_SCOPE);
        if((arg != null) && arg.isPresent()) {
    ...
    public final File getBindPasswordFile() {
        ...
        Argument argument = argumentParser.getNamedArgument(argName);
        return argument == null ? null : ((FileArgument)argument).getValue();
    }
    ...
    */
        ...
        final String description =
                "Whether the LDAP SDK should automatically reconnect when a " +
                        "connection is " +
                        "lost.";
    ...
    */
    ...
    public boolean getAutoReconnect() {
        ...
        final BooleanArgument arg = (BooleanArgument)argumentParser.getNamedArgument
                (argName);
    ...
    public Object getConnectTimeoutMillis() {
        ...
        final IntegerArgument integerArgument =
                (IntegerArgument)argumentParser.getNamedArgument(argName);
    ...
    public String getBaseObject() throws LDAPException {
        ...
        final StringArgument arg =
                (StringArgument)argumentParser.getNamedArgument(argName);
        return arg.getValue();
    }
