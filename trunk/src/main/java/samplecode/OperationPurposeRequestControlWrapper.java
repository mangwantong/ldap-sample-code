...
/**
 * Provides clients with a method to obtain an OperationPurposeRequest control,
 * and throws an exception if that control is not available.
 */
class OperationPurposeRequestControlWrapper {

    /**
     * Creates a new instance of {@code OperationPurposeRequestControlWrapper}
     ...
     */
    static OperationPurposeRequestControlWrapper newOperationPurposeRequestControlWrapper(
	...
	return new OperationPurposeRequestControlWrapper(isCritical,
		applicationName, applicationVersion, codeLocationFrames,
		requestPurpose);
    }
     ...
     * @param applicationName
     *            The name of the application generating the associated request.
     *            It may be {@code null} if this should not be included in the
     *            control.
     * @param applicationVersion
     *            Information about the version of the application generating
     *            the associated request. It may be {@code null} if this should
     *            not be included in the control.
     * @param codeLocationFrames
     *            Indicates that the code location should be automatically
     *            generated with a condensed stack trace for the current thread,
     *            using the specified number of stack frames. A value that is
     *            less than or equal to zero indicates an unlimited number of
     *            stack frames should be included.
     * @param requestPurpose
     *            A string identifying the purpose of the associated request. It
     *            may be {@code null} if this should not be included in the
     *            control.
     * @throws ClassNotFoundException
     ...
     */
    private OperationPurposeRequestControlWrapper(final boolean isCritical,
	...
	final OperationPurposeRequestControlSupportedClass supportedClass =
		OperationPurposeRequestControlSupportedClass.newSupportedClass(
			isCritical, applicationName, applicationVersion,
