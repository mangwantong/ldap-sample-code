...
class OperationPurposeRequestControlWrapper
{
  ...
  static OperationPurposeRequestControlWrapper newOperationPurposeRequestControlWrapper(
          ...
          final String requestPurpose) throws ClassNotFoundException,InstantiationException,
          IllegalAccessException,SecurityException,IllegalArgumentException,
          NoSuchMethodException,InvocationTargetException
  {
    return new OperationPurposeRequestControlWrapper(isCritical,applicationName,
