        ...
        extends AbstractTool
{
  ...
  private static class InMemoryDirectoryServices
  {
     ...
     *           from the file.
     */
    private void getEntriesFromFile(final File ldifFile) throws IOException,LDIFException,
            LDAPException
    {
            ...
            throws LDAPException,LDIFException,IOException
    {
      ...
      final LogRecord logRecord = new LogRecord(Level.INFO,"in-memory-server created.");
