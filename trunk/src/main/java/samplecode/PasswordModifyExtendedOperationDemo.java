...

{
  ...
  public static void main(final String... args)
  {
    ...
    final ToolCompletedProcessing completedProcessing =
        new BasicToolCompletedProcessing(passwordModifyExtendedOperationDemo,
            resultCode);
  ...
  public ResultCode doToolProcessing()
  {
    ...
    builder
        .append(" Use '--bindDn DN' to specify the bind DN or use '--help'.");
    ...
    catch(final LDAPException ldapException)
    {
      ...
      builder.append(String.format(
          " failed to change password at server ldap://%s:%d",hostname,port));
