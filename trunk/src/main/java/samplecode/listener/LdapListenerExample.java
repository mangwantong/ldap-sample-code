...
public final class LdapListenerExample extends AbstractTool
{
  ...
  private static class InMemoryDirectoryServices
  {
     ...
     * command line.
     *
     * @param commandLineOptions  The object that manages command line options.
     * @param ldapCommandLineTool The object that provides the command line framework.
     * @return a new and distinct {@code InMemoryDirectoryServices}
     *         object.
     * @throws LDAPException If errors related to an LDAP request, connection, DNs,
     *                       or other LDAP-related exceptions occur.
     * @throws LDIFException When there is something wrong with the file containing
     *                       LDIF, or the file does not exist, or something of that
     *                       sort.
     * @throws IOException   If an error occurs when reading the file containing
     *                       LDIF
     */
            ...
            throws LDAPException, LDIFException, IOException
    {
      ...
      return new InMemoryDirectoryServices(commandLineOptions, ldapCommandLineTool);
    }
            ...
            throws LDAPException, LDIFException, IOException
    {
      ...
      final class SchemaFiles
      {
         ...
         */
        private SchemaFiles(final List<File> schemaFiles)
        {
      ...
      ldapCommandLineTool.out("in-memory-server created.");
    }
     ...
     * @throws LDAPException If an error occurs starting the server.
     */
     ...
     * {@link InMemoryDirectoryServerListener#entryAction(LDAPCommandLineTool,
     * CommandLineOptions, LDAPConnectionPool, Entry)}
            ...
            throws IOException, LDIFException, LDAPException
    {
      ...
      while(true)
      {
        ...
        {
          l.entryAction(ldapCommandLineTool, commandLineOptions, ldapConnectionPool, entry);
        }
      }
      ldifReader.close();
    }
  ...
  private static class LocalCommandLineOptions extends CommandLineOptions
  {
  ...
  private interface InMemoryDirectoryServerListener
  {
     ...
     * entry.
     *
     * @param ldapCommandLineTool The object which provides services associated with
     *                            running the program from the command line.
     * @param commandLineOptions  The command line argument service provider.
     * @param ldapConnectionPool  A valid {@code LDAPConnectionPool}.
     * @param entry               A directory server entry.
     * @return The result code from any action that was taken by the
     *         method.
     * @throws LDAPException if an error occurs with an LDAP request or response or
     *                       with the server.
     */
    ResultCode entryAction(LDAPCommandLineTool ldapCommandLineTool,
            CommandLineOptions commandLineOptions, LDAPConnectionPool ldapConnectionPool,
  ...
  static
  {
    ...
    TOOL_DESCRIPTION =
            "An example demonstrating how to create and use an " + "in-memory directory " +
                    "server for testing. The demonstration creates an " + "in-memory " +
                    "directory server using the naming context specified by " + "the " +
                    "--namingContext parameter, adds schema files specified by " + "the " +
                    "--schemaFile command line argument (which can occur multiple times), " +
  ...
  public ResultCode executeToolTasks()
  {
    ...
    final InMemoryDirectoryServerListener displayEntryListener =
            new InMemoryDirectoryServerListener()
            {
              ...
              @Override
              public ResultCode entryAction(final LDAPCommandLineTool ldapCommandLineTool,
                      final CommandLineOptions commandLineOptions,
    ...
    try
    {
      ...
      inMemoryDirectoryServices =
              InMemoryDirectoryServices.newLdapListenerExampleDemo(commandLineOptions, this);
    ...
    {
      final StringBuilder builder = new StringBuilder("An LDAP Exception was detected: ");
